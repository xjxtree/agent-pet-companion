{
  ...
  "hooks": {
    ...
    "PreCompact": [{"hooks":[{"type":"command","command":"__APC_CLI__ agent hook --source codex --event-type auto >/dev/null 2>&1"}]}],
    "PostCompact": [{"hooks":[{"type":"command","command":"__APC_CLI__ agent hook --source codex --event-type auto >/dev/null 2>&1"}]}],
    "SubagentStart": [{"hooks":[{"type":"command","command":"__APC_CLI__ agent hook --source codex --event-type auto >/dev/null 2>&1"}]}],
    "SubagentStop": [{"hooks":[{"type":"command","command":"__APC_CLI__ agent hook --source codex --event-type auto >/dev/null 2>&1"}]}],
