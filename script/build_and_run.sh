...
pkill -x petcore >/dev/null 2>&1 || true
...
cp "$ROOT_DIR/target/debug/petcore" "$APP_RESOURCES/bin/petcore"
cp "$ROOT_DIR/target/debug/petcore-cli" "$APP_RESOURCES/bin/petcore-cli"
