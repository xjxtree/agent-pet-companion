...
| Swift tests | PASS，95 tests / 10 suites（含旧 `apc.runtime-manifest.v1` 新增字段重建回归） |
...
- 当前 develop build：`0.1.0.1.20260715184943.78233`。
- ZIP SHA-256：`4219f188cd2cbb4fff969145d793fa8fef2f61ae7cc1af79adfd3c0690ad086b`。
